...
const dataset = await gdal.openAsync('../road_source.geojson');
const layer = dataset.layers.get(0);

const options = [
    '-f', 'SQLite', // Output format
    '-lco', 'ENCODING=UTF-8' // Optional: Set encoding
];

await gdal.vectorTranslateAsync('temp.sqlite', layer,  options);
