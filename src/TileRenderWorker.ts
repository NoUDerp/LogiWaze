...
export default async function control(controlArguments: any,
                                      road_sources: any,
                                      variogram:
                                      {
                                          t,
    ...
    const hdRatio = controlArguments[2];
    const gridX = controlArguments[3];
    const gridY = controlArguments[4];
    const args = controlArguments[5] as {
